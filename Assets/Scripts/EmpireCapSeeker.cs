...
public class EmpireCapSeeker : Vehicle {
	...
	protected override void CalcSteeringForce(){
		...
		//force += seekWt * Seek(target.transform.position);
		force += alignmentWt * Alignment(gm.EmpireCapsDirection);
		force += separationWt * Separation(gm.EmpireCaps, separationDist);
		force += cohesionWt * Cohesion(gm.EmpireCapsCentroid);
