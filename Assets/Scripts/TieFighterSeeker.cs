...
public class TieFighterSeeker : Vehicle {
	...
	protected override void CalcSteeringForce(){
		...
		if (target != null) 
		{
			...
			force += alignmentWt * Alignment(gm.EmpireTiesDirection);
			force += separationWt * Separation(gm.EmpireTies, separationDist);
			force += cohesionWt * Cohesion(gm.EmpireTiesCentroid);
